...
namespace data_policies
{
	namespace policies
	{
		...
		namespace constraints
		{
			...
			template <typename T>//, bool Is_Numeric_Type = std::is_arithmetic<T>::value>
			class Number_Range
			{
			...
			// Is there a way of making this spit out a more direct warning?...
			/*
			template <typename T>
			class Number_Range < T, false >
			{
